...
const DEFAULT_LESSONS = {
  1: {
    ...
    grammar: [
      ...
      { jp: "しごとは なんですか？", en: "What is your job?", roma: "Shigoto wa nan desuka?" },
      { jp: "わたしは {NAME} じゃありません", en: "I am not {NAME}", roma: "Watashi wa {NAME} jya arimasen" },
      { jp: "あの かたは どなたですか？", en: "Who is that person? (polite)", roma: "Ano kata wa donata desuka?" },
      { jp: "あの ひとは だれですか？", en: "Who is that person? (casual)", roma: "Ano hito wa dare desuka?" },
      { jp: "{NAME}さんは {PLACE}の {NOUN} です", en: "{NAME} is a {NOUN} of {PLACE}", roma: "{NAME} san wa {PLACE} no {NOUN} desu" },
      { jp: "おいくつですか？", en: "How old are you? (polite)", roma: "Oikutsu desuka?" },
      { jp: "なんさいですか？", en: "How old are you? (casual)", roma: "Nan sai desuka?" },
    ],
    vocab: [
      { jp: "がくせい", roma: "gakusei", en: "student" },
      { jp: "かいしゃいん", roma: "kaishain", en: "company employee" },
      { jp: "せんせい", roma: "sensei", en: "teacher" },
      { jp: "しごと", roma: "shigoto", en: "job / work" },
      { jp: "にほんじん", roma: "nihonjin", en: "Japanese person" },
      { jp: "カナダじん", roma: "kanadajin", en: "Canadian" },
      { jp: "アメリカじん", roma: "amerikajin", en: "American" },
      { jp: "ちゅうごくじん", roma: "chuugokujin", en: "Chinese person" },
      { jp: "かんこくじん", roma: "kankokujin", en: "Korean person" },
      { jp: "どいつじん", roma: "doitsujin", en: "German person" },
      { jp: "いぎりすじん", roma: "igirisujin", en: "British person" },
      { jp: "フランスじん", roma: "furansujin", en: "French person" },
      { jp: "スペインじん", roma: "supeinjin", en: "Spanish person" },
      { jp: "なまえ", roma: "namae", en: "name" },
      { jp: "なんさい", roma: "nansai", en: "how old" },
      { jp: "だれ", roma: "dare", en: "who" },
      { jp: "どなた", roma: "donata", en: "who (polite)" },
      { jp: "だいがく", roma: "daigaku", en: "university" },
      { jp: "びょういん", roma: "byouin", en: "hospital" },
      { jp: "いしゃ", roma: "isha", en: "doctor" },
      { jp: "ぎんこういん", roma: "ginkouin", en: "bank employee" },
    ],
  },
  2: {
    ...
    grammar: [
      ...
      { jp: "これは {A}ですか？ {B}ですか？", en: "Is this {A} or {B}?", roma: "Kore wa {A} desuka? {B} desuka?" },
      { jp: "これは なんの {NOUN} ですか？", en: "What kind of {NOUN} is this?", roma: "Kore wa nanno {NOUN} desuka?" },
      { jp: "これは だれの {NOUN} ですか？", en: "Whose {NOUN} is this?", roma: "Kore wa dare no {NOUN} desuka?" },
      { jp: "この {NOUN} は だれのですか？", en: "Whose is this {NOUN}?", roma: "Kono {NOUN} wa dare no desuka?" },
      { jp: "はい、そうです", en: "Yes, that's right", roma: "Hai, sou desu" },
      { jp: "いいえ、ちがいます", en: "No, that's wrong", roma: "Iie, chigaimasu" },
      { jp: "これは {NOUN}の {NOUN} です", en: "This is {NOUN}'s {NOUN}", roma: "Kore wa {NOUN} no {NOUN} desu" },
    ],
    vocab: [
      ...
      { jp: "その", roma: "sono", en: "that (+ noun)" },
      { jp: "あの", roma: "ano", en: "that over there (+ noun)" },
      { jp: "ほん", roma: "hon", en: "book" },
      { jp: "ざっし", roma: "zasshi", en: "magazine" },
      { jp: "しんぶん", roma: "shinbun", en: "newspaper" },
      { jp: "とけい", roma: "tokei", en: "clock / watch" },
      { jp: "かぎ", roma: "kagi", en: "key" },
      { jp: "つくえ", roma: "tsukue", en: "desk" },
      { jp: "いす", roma: "isu", en: "chair" },
      { jp: "くつ", roma: "kutsu", en: "shoes" },
      { jp: "くるま", roma: "kuruma", en: "car" },
      { jp: "さいふ", roma: "saifu", en: "wallet" },
      { jp: "はこ", roma: "hako", en: "box" },
      { jp: "ノートパソコン", roma: "nooto pasokon", en: "laptop" },
      { jp: "えいご", roma: "eigo", en: "English (language)" },
      { jp: "にほんご", roma: "nihongo", en: "Japanese (language)" },
      { jp: "かんこくご", roma: "kankokugo", en: "Korean (language)" },
      { jp: "ちゅうごくご", roma: "chuugokugo", en: "Chinese (language)" },
      { jp: "わたしの", roma: "watashi no", en: "mine" },
      { jp: "あなたの", roma: "anata no", en: "yours" },
    ],
  },
  3: {
    ...
    grammar: [
      ...
      { jp: "ここは {NOUN} です", en: "This place is {NOUN}", roma: "Koko wa {NOUN} desu" },
      { jp: "{NOUN} は どこですか？", en: "Where is {NOUN}?", roma: "{NOUN} wa doko desuka?" },
      { jp: "{NOUN} は あそこです", en: "{NOUN} is over there", roma: "{NOUN} wa asoko desu" },
      { jp: "{NOUN} は なんかいですか？", en: "What floor is {NOUN}?", roma: "{NOUN} wa nankai desuka?" },
      { jp: "{NUMBER}かい です", en: "It is floor {NUMBER}", roma: "{NUMBER} kai desu" },
    ...
    vocab: [
      ...
      { jp: "こちら", roma: "kochira", en: "here (polite)" },
      { jp: "そちら", roma: "sochira", en: "there (polite)" },
      { jp: "あちら", roma: "achira", en: "over there (polite)" },
      { jp: "どちら", roma: "dochira", en: "where (polite)" },
      ...
      { jp: "ラーメンや", roma: "raamenya", en: "ramen shop" },
      { jp: "くつや", roma: "kutsuya", en: "shoe store" },
      { jp: "ふくや", roma: "fukuya", en: "clothing store" },
      { jp: "パンや", roma: "panya", en: "bakery" },
      { jp: "ちかいっかい", roma: "chika ikkai", en: "basement floor 1" },
      { jp: "やさい", roma: "yasai", en: "vegetables" },
    ],
  },
  4: {
    ...
    grammar: [
      ...
      { jp: "いま {N}じ です", en: "It is {N} o'clock now", roma: "Ima {N} ji desu" },
      { jp: "{PLACE} は なんじから なんじまで ですか？", en: "What hours is {PLACE} open?", roma: "{PLACE} wa nanji kara nanji made desuka?" },
      { jp: "なんじから なんじまで {VERB}ますか？", en: "From what time to what time do you {VERB}?", roma: "Nanji kara nanji made {VERB} masuka?" },
      { jp: "なんじに {VERB}ますか？", en: "What time do you {VERB}?", roma: "Nanji ni {VERB} masuka?" },
      { jp: "{PLACE} は なんようびから なんようびまで ですか？", en: "What days is {PLACE} open?", roma: "{PLACE} wa nanyoubi kara nanyoubi made desuka?" },
      { jp: "{VERB}ます / {VERB}ません", en: "present positive / present negative", roma: "{VERB} masu / {VERB} masen" },
      { jp: "{VERB}ました / {VERB}ませんでした", en: "past positive / past negative", roma: "{VERB} mashita / {VERB} masen deshita" },
    ],
    vocab: [
      ...
      { jp: "ごぜん", roma: "gozen", en: "AM / morning" },
      { jp: "ごご", roma: "gogo", en: "PM / afternoon" },
      { jp: "いま", roma: "ima", en: "now" },
      { jp: "はん", roma: "han", en: "half (past)" },
      { jp: "ふん / ぷん", roma: "fun / pun", en: "minutes" },
      { jp: "から", roma: "kara", en: "from" },
      { jp: "まで", roma: "made", en: "to / until" },
      { jp: "ねます", roma: "nemasu", en: "sleep" },
      { jp: "おきます", roma: "okimasu", en: "wake up" },
      { jp: "はたらきます", roma: "hatarakimasu", en: "work" },
      { jp: "やすみます", roma: "yasumimasu", en: "rest / take a day off" },
      { jp: "かえります", roma: "kaerimasu", en: "go home / return" },
      { jp: "べんきょうします", roma: "benkyou shimasu", en: "study" },
      { jp: "きのう", roma: "kinou", en: "yesterday" },
      { jp: "きょう", roma: "kyou", en: "today" },
      { jp: "あした", roma: "ashita", en: "tomorrow" },
      { jp: "おととい", roma: "ototoi", en: "day before yesterday" },
      { jp: "あさって", roma: "asatte", en: "day after tomorrow" },
      { jp: "まいにち", roma: "mainichi", en: "every day" },
      { jp: "まいあさ", roma: "maiasa", en: "every morning" },
      { jp: "まいばん", roma: "maiban", en: "every evening" },
      { jp: "せんしゅう", roma: "senshuu", en: "last week" },
      { jp: "こんしゅう", roma: "konshuu", en: "this week" },
      { jp: "らいしゅう", roma: "raishuu", en: "next week" },
      { jp: "せんげつ", roma: "sengetsu", en: "last month" },
      { jp: "こんげつ", roma: "kongetsu", en: "this month" },
      { jp: "らいげつ", roma: "raigetsu", en: "next month" },
      { jp: "ことし", roma: "kotoshi", en: "this year" },
      { jp: "あさ", roma: "asa", en: "morning" },
      { jp: "よる", roma: "yoru", en: "night / evening" },
      { jp: "けさ", roma: "kesa", en: "this morning" },
      { jp: "こんばん", roma: "konban", en: "this evening" },
    ],
  },
  5: {
    title: "Lesson 5 – Going Places",
    grammar: [
      { jp: "{PLACE} へ いきます", en: "I go to {PLACE}", roma: "{PLACE} e ikimasu" },
      { jp: "{PLACE} へ いきました", en: "I went to {PLACE}", roma: "{PLACE} e ikimashita" },
      { jp: "{VEHICLE} で {PLACE} へ いきます", en: "I go to {PLACE} by {VEHICLE}", roma: "{VEHICLE} de {PLACE} e ikimasu" },
      { jp: "なにで {PLACE} へ いきますか？", en: "How do you go to {PLACE}?", roma: "Nani de {PLACE} e ikimasuka?" },
      { jp: "{PERSON} と {PLACE} へ いきます", en: "I go to {PLACE} with {PERSON}", roma: "{PERSON} to {PLACE} e ikimasu" },
      { jp: "だれと {PLACE} へ いきますか？", en: "Who do you go to {PLACE} with?", roma: "Dare to {PLACE} e ikimasuka?" },
      { jp: "いつ {PLACE} へ いきますか？", en: "When do you go to {PLACE}?", roma: "Itsu {PLACE} e ikimasuka?" },
      { jp: "たんじょうびは いつですか？", en: "When is your birthday?", roma: "Tanjoubi wa itsu desuka?" },
      { jp: "どこへも いきませんでした", en: "I didn't go anywhere", roma: "Doko e mo ikimasen deshita" },
    ],
    vocab: [
      ...
      { jp: "じてんしゃ", roma: "jitensha", en: "bicycle" },
      { jp: "ひこうき", roma: "hikouki", en: "airplane" },
      { jp: "くるま", roma: "kuruma", en: "car" },
      { jp: "ふね", roma: "fune", en: "boat / ship" },
      { jp: "あるき", roma: "aruki", en: "on foot / walking" },
      { jp: "バイク", roma: "baiku", en: "motorcycle" },
      { jp: "ひとりで", roma: "hitori de", en: "alone" },
      { jp: "ともだち", roma: "tomodachi", en: "friend" },
      { jp: "かぞく", roma: "kazoku", en: "family" },
      { jp: "かのじょ", roma: "kanojo", en: "girlfriend" },
      { jp: "たんじょうび", roma: "tanjoubi", en: "birthday" },
      { jp: "いつ", roma: "itsu", en: "when" },
      { jp: "ゆうびんきょく", roma: "yuubinkyoku", en: "post office" },
      { jp: "コンビニ", roma: "konbini", en: "convenience store" },
      { jp: "デパート", roma: "depaato", en: "department store" },
      { jp: "スーパー", roma: "suupaa", en: "supermarket" },
      { jp: "ぎんこう", roma: "ginkou", en: "bank" },
      { jp: "としょかん", roma: "toshokan", en: "library" },
      { jp: "びじゅつかん", roma: "bijutsukan", en: "art museum" },
      { jp: "えき", roma: "eki", en: "station" },
      { jp: "くに", roma: "kuni", en: "country / homeland" },
    ],
  },
  6: {
    ...
    grammar: [
      ...
      { jp: "なにを {VERB}ますか？", en: "What do you {VERB}?", roma: "Nani o {VERB} masuka?" },
      { jp: "なにも {VERB}ません", en: "I don't {VERB} anything", roma: "Nani mo {VERB} masen" },
      { jp: "だれと あいますか？", en: "Who do you meet with?", roma: "Dare to aimasuka?" },
      { jp: "だれとも あいません", en: "I don't meet anybody", roma: "Dare to mo aimasen" },
      { jp: "どこで {NOUN} を {VERB}ますか？", en: "Where do you {VERB} {NOUN}?", roma: "Doko de {NOUN} o {VERB} masuka?" },
      ...
      { jp: "{VERB}ましょう", en: "Let's {VERB}", roma: "{VERB} mashou" },
      { jp: "それから", en: "After that / then", roma: "Sorekara" },
    ],
    vocab: [
      ...
      { jp: "とります", roma: "torimasu", en: "take (photos)" },
      { jp: "すいます", roma: "suimasu", en: "smoke / inhale" },
      { jp: "あいます", roma: "aimasu", en: "meet" },
      { jp: "します", roma: "shimasu", en: "do" },
      { jp: "いっしょに", roma: "issho ni", en: "together" },
      { jp: "いつも", roma: "itsumo", en: "always" },
      { jp: "ときどき", roma: "tokidoki", en: "sometimes" },
      { jp: "それから", roma: "sorekara", en: "after that / then" },
      { jp: "パン", roma: "pan", en: "bread" },
      { jp: "ごはん", roma: "gohan", en: "rice / meal" },
      { jp: "あさごはん", roma: "asagohan", en: "breakfast" },
      { jp: "ひるごはん", roma: "hirugohan", en: "lunch" },
      { jp: "ばんごはん", roma: "bangohan", en: "dinner" },
      { jp: "みず", roma: "mizu", en: "water" },
      { jp: "こうちゃ", roma: "koucha", en: "black tea" },
      { jp: "おんがく", roma: "ongaku", en: "music" },
      { jp: "えいが", roma: "eiga", en: "movie" },
      { jp: "てがみ", roma: "tegami", en: "letter" },
      { jp: "レポート", roma: "repooto", en: "report" },
      { jp: "しゅくだい", roma: "shukudai", en: "homework" },
      { jp: "くだもの", roma: "kudamono", en: "fruit" },
      { jp: "やきゅう", roma: "yakyuu", en: "baseball" },
      { jp: "サッカー", roma: "sakkaa", en: "soccer" },
      { jp: "しょくどう", roma: "shokudou", en: "cafeteria / dining hall" },
      { jp: "いえ", roma: "ie", en: "house / home" },
      { jp: "がっこう", roma: "gakkou", en: "school" },
    ],
  },
};
...
const GREETINGS = [
  ...
  { jp: "ありがとう", roma: "Arigatou", en: "Thank you" },
  { jp: "ありがとうございます", roma: "Arigatou gozaimasu", en: "Thank you very much" },
  { jp: "すみません", roma: "Sumimasen", en: "Excuse me / I'm sorry" },
  { jp: "ごめんなさい", roma: "Gomen nasai", en: "I'm sorry" },
  { jp: "げんきですか？", roma: "Genki desuka?", en: "How are you?" },
  { jp: "げんきです", roma: "Genki desu", en: "I'm fine" },
  { jp: "げんきじゃありません", roma: "Genki jya arimasen", en: "I'm not well" },
  { jp: "いただきます", roma: "Itadakimasu", en: "Said before eating" },
  { jp: "ごちそうさまでした", roma: "Gochisousama deshita", en: "Said after eating" },
  { jp: "ただいま", roma: "Tadaima", en: "I'm home" },
  { jp: "おかえり", roma: "Okaeri", en: "Welcome back" },
  { jp: "またね", roma: "Mata ne", en: "See you" },
  { jp: "わかりました", roma: "Wakarimashita", en: "I understood" },
  { jp: "わかりません", roma: "Wakarimasen", en: "I don't understand" },
  { jp: "だいじょうぶです", roma: "Daijoubu desu", en: "I'm OK / It's fine" },
  { jp: "しつもんがあります", roma: "Shitsumon ga arimasu", en: "I have a question" },
  { jp: "おじゃまします", roma: "Ojama shimasu", en: "Greeting when entering someone's home" },
  { jp: "どうぞ", roma: "Douzo", en: "Please (offering)" },
  { jp: "いくらですか？", roma: "Ikura desuka?", en: "How much is it?" },
];
